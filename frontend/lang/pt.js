...
window._LANG_PT = {
    ...
    'tab.projects':'Projetos','tab.cycles':'Ciclos','tab.team':'Equipe','tab.my':'Minha Área',
    ...
    'cycles.section_title':'Ciclos de Faturamento','cycles.title':'Ciclos cadastrados','btn.new_cycle':'+ Novo ciclo',
    ...
    'projects.th.budget':'Orçamento (h)','projects.th.budget_tip':'Horas orçadas do projeto. O badge indica alerta de custo em R$.','projects.th.status':'Status',
    ...
    'btn.cancel':'Cancelar','btn.save':'Salvar','btn.edit':'Editar','btn.delete':'Excluir','btn.more_actions':'Mais ações',
    ...
    'baseline.create':'Criar Baseline','baseline.history':'Histórico de Baselines','baseline.diff_title':'Variação entre últimas revisões',
    ...
    'stats.projects':'Projetos','stats.budget_h':'Total orçado','stats.with_baseline':'Com baseline','stats.at_risk':'Em atenção',
    ...
    'collab.section_radar': 'Perfil do Colaborador',
    'radar.volume': 'Volume',
    'radar.extra': 'Extra%',
    'radar.standby': 'Sobreaviso%',
    'radar.regularity': 'Regularidade',
    'radar.presence': 'Presença',
    ...
    'toolbox.brush_rect':'Selecionar área','toolbox.brush_clear':'Limpar seleção',
    'scatter.brush_n_selected':'{n} projetos selecionados',
    'scatter.brush_clear':'Limpar seleção',
    ...
    'notif.upload_success': 'Upload processado com sucesso',
    'notif.upload_warning': 'Upload processado com avisos',
    ...
    'appearance.open_btn': '🎨 Personalizar Aparência',
    'appearance.modal_title': 'Personalizar Aparência',
    'appearance.col_structure': 'Estrutura',
    'appearance.col_interaction': 'Interação',
    'appearance.col_semantic': 'Semântica',
    'appearance.col_palette': 'Paleta de gráficos',
    'appearance.col_layout': 'Layout e tipografia',
    'appearance.font_family': 'Fonte',
    'appearance.border_radius': 'Raio dos cantos',
    'appearance.radius_sharp': 'Reto',
    'appearance.radius_normal': 'Normal',
    'appearance.radius_rounded': 'Arredondado',
    'appearance.optional': 'opcional',
    'appearance.f_bg': 'Fundo',
    'appearance.f_surface': 'Superfície',
    'appearance.f_card': 'Card',
    'appearance.f_border': 'Borda',
    'appearance.f_primary': 'Primária',
    'appearance.f_accent': 'Destaque',
    'appearance.f_text': 'Texto',
    'appearance.f_text2': 'Texto muted',
    'appearance.f_text3': 'Texto hint',
    'appearance.f_success': 'Sucesso',
    'appearance.f_warning': 'Alerta',
    'appearance.f_danger': 'Perigo',
    'appearance.f_violet': 'Violeta',
    ...
    'page.label':'Página','page.of':'de','page.items_label':'Itens:',
    ...
    'sec.default_pass.title':'Senha padrão ativa — risco de segurança',
    'sec.default_pass.body':'Você está usando a senha padrão <b>admin/admin</b>. Altere-a imediatamente para proteger o sistema.',
    'sec.default_pass.cta':'Alterar senha agora',
'burnup.eac':'EAC (Estimativa no Término)',
    ...
    // Error messages
    'err.unauthorized': 'Sessão expirada. Faça login novamente.',
    'err.not_found': 'Recurso não encontrado.',
